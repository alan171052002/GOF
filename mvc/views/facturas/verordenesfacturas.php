    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table table-dark table-striped">
                ...
                <tbody>
                    <?php foreach ($data["getOrdenesAsociadas"] as $factura): ?>
                        <tr>
                            <td>
                                <h3><?= $factura["numero_orden"]; ?></h3>
                            </td>
                            <td>
                                <button onclick="openModelPDF('<?php echo $factura['pdf_orden'] ?>')"
                                    class="btn btn-outline-danger" type="button">Ver Orden de Compra</button>
                            </td>
        ...
        <a href="home.php?c=facturas&a=index" class="btn btn-secondary">Volver</a>
    </div>
