...
<body>
    <div class="container">
        ...
        <form id="nuevo" name="nuevo" method="POST" action="home.php?c=facturas&a=actualizar" autocomplete="off"
            enctype="multipart/form-data">
            <input class="labelo" type="hidden" id="num_factura" name="num_factura" value="<?php echo $data["num_factura"]; ?>" />
            <div class="form-group">
                <label for="Nombre">
                    <h3>
                        <?php echo $data["num_factura"]; ?>
                    </h3>
                </label>
            </div>
            ...
            <div class="form-group">
                <label for="fecha" class="labelo">Fecha</label>
                <input class="form-control" type="date" id="fecha" name="fecha" />

            </div>
            <div class="form-group">
                <label for="Parcialidades" class="labelo">Parcialidades</label>
                <input class="form-control"id="parcialidades" name="parcialidades" />
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                var depaValue = document.getElementById('fecha').value.trim();
